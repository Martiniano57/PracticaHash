...
using REF_PracticaHash;
using REF_PracticaHash.Framework.Logica.GetData;
using REF_PracticaHash.ObjectRepository;
using System.Data;
...
[assembly: WorkflowRunnerServiceAttribute(typeof(REF_PracticaHash.WorkflowRunnerService))]
namespace REF_PracticaHash
{
    public class WorkflowRunnerService
    {
        ...
        /// <summary>
        /// Invokes the Framework/Logica/GetData/LogicGetData_ObtenerTabla.cs
        /// </summary>
        /// <param name="isolated">Indicates whether to isolate executions (run them within a different process)</param>
        public void LogicGetData_ObtenerTabla(System.Boolean isolated = false)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"Framework\Logica\GetData\LogicGetData_ObtenerTabla.cs", new Dictionary<string, object> { }, default, isolated, default, GetAssemblyName());
        }
        ...
        /// </summary>
        /// <param name="isolated">Indicates whether to isolate executions (run them within a different process)</param>
        public void Process(UiPath.Core.QueueItem in_TransactionItem, System.Collections.Generic.Dictionary<string, object> in_Config, System.Boolean isolated = false)
        {
