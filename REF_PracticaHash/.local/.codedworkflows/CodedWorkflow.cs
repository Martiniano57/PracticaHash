...
namespace REF_PracticaHash
{
    ...
    {
        private Lazy<global::REF_PracticaHash.WorkflowRunnerService> _workflowRunnerServiceLazy;
        ...
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<global::REF_PracticaHash.WorkflowRunnerService>(() => new global::REF_PracticaHash.WorkflowRunnerService(this.services));
#pragma warning disable
            _connectionsManagerLazy = new Lazy<ConnectionsManager>(() => new ConnectionsManager(serviceContainer));
#pragma warning restore
        }

        protected global::REF_PracticaHash.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
